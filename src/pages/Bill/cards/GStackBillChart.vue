<template>
  <div>
    <div ref="amChartXYChart" :style="styleObject"></div>
  ...
  methods: {
    setChartInfo(data) {
      ...
      switch (this.chartTheme) {
        ...
        case 'dash_aiPattern' :
          ...
          if (i18n.locale === 'ko') {
            thisMonth = moment(this.data[0].billYm).format("M");
            nextMonth = moment(this.data[0].billYm).subtract(1,'months').format("M");
            this.chartOption.series.customName = [thisMonth+"월", nextMonth+"월", "Max", "Avg"];
          } else {
            thisMonth = moment(this.data[0].billYm).format("MMMM");
            nextMonth = moment(this.data[0].billYm).subtract(1,'months').format("MMMM");
            this.chartOption.series.customName = [thisMonth, nextMonth, "Max", "Avg"];
          }
          this.chartOption.cateAxis.gridDistance = 0;
          this.chartOption.cateAxis.tooltipHide = true;
          this.chartOption.cateAxis.axisHide = false;
        ...
        case 'bill_trend':
          ...
          this.chartOption.legend.height = 140;
          this.chartOption.legend.fontSize = 14;
          this.chartOption.legend.overflow = 'hidden';
    ...
    createChart(data) {
      ...
      if (this.chartOption.legend.isUse) {
        ...
        chart.legend.overflow = this.chartOption.legend.overflow;
      ...
      if (this.chartOption.series.isCustomTooltip) {
        series.adapter.add('tooltipHTML', (html, target) => {
          ...
          if (i18n.locale === 'ko') {
            ...
            strHtml = "<div class='aiPatternDiv'>" + data.cspPrdtCd + "</br></br>" ;
            ...
            thisMonth = moment(data.billYm).format("MMMM");
            nextMonth = moment(data.billYm).subtract(1,'months').format("MMMM");
            strHtml = "<div class='aiPatternDiv'>" + data.cspPrdtCd + "</br></br>" ;

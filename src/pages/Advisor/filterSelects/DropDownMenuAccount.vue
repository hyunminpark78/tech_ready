...
export default {
  ...
  computed: {
    ...mapState('spotAdvisor', { filter: 'filter', storeCategory: 'category', companyId: 'selectedCustCorpIds' }),
    isOpened() {
  ...
  methods: {
    ...mapActions('spotAdvisor', ['fetchFilter', 'fetchSearch', 'fetchParam', 'setFilter', 'fetchSelectedCorpCustIds']),
    setAllItem() {
      if (i18n.locale === 'ko') {
        this.allItem = {
          id: 'checkAll',

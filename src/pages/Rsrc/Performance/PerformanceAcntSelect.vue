...
export default {
  ...
  computed: {
    ...mapState('performance', { filter: 'filter', storeCategory: 'category', companyId: 'selectedCustCorpIds' }),
    isOpened() {
  ...
  methods: {
    ...mapActions('performance', ['fetchFilter', 'fetchSearch', 'fetchParam', 'setFilter', 'fetchSelectedCorpCustIds']),
    setAllItem() {
      if (i18n.locale === 'ko') {
        this.allItem = {
          id: 'checkAll',

...
export default Vue.extend({
  ...
  template: `
    <div v-if="showButton">
      <button class="ico-write" title="Update" @click="acctUpdatePage()" >수정</button>
      <button class="ico-delete" style="margin-left: 10px;" title="Delete" @click="acctDeletePage()">삭제</button>
    </div>
    <div v-else>
      <button class="ico-qna" title="Inquiry" @click="getInquiryPopup()" >문의</button>
    </div>`,
});

...
import Cost, { BillInfo, BillRpt, CostEx, CostPattern, AnomalCostDetect, CtrtInfo, History } from '@/pages/Cost';
...
import Setting, { AwsAcctMgmt, AwsAcctCreate, AwsAcctDelete, SvcGrpMgmt, Notification } from '@/pages/Setting';
...
const COMPONENT = {
  ...
  SETTING_AWSACCTMGMT: AwsAcctMgmt,
